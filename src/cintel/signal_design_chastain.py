"""
signal_design_chastain.py - Project script (example).
...
Terminal command to run this file from the root project folder
    ...
    uv run python -m cintel.signal_design_chastain
...
DATA_FILE: Final[Path] = DATA_DIR / "system_metrics_chastain.csv"
OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "signals_chastain.csv"
